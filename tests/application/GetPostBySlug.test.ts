...
import { GetPostBySlug } from "../../src/application/post/GetPostBySlug.js";
...
describe("GetPostBySlug Use Case", () => {
  it("should return post by slug", async () => {
    ...
    const useCase = new GetPostBySlug(repo);

    const result = await useCase.execute({ slug: "mi-post" });
